    ...
    <div className="flex h-full w-full flex-col items-center space-y-8 rounded-2xl border border-gray-200 bg-white px-4 py-12 text-left text-primary shadow-lg">
      {image_url ? (
        <div className="avatar">
          <div className="w-36 rounded-full md:w-48 flex items-center justify-center">
      ...
      <div className="flex w-full flex-col items-start space-y-4 p-2 text-primary">
        <div className="my-4 flex w-full flex-row items-center space-x-4">
        ...
        <div className="flex w-full flex-row space-x-4">
          ...
          <div className="flex flex-col truncate">
            <p>Email</p>
            <a className="truncate text-blue-600" href={`mailto:${email}`}>{email}</a>
          </div>
        </div>
        <div className="flex w-full flex-row space-x-4">
